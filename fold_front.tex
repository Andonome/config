...
\posterbox[fit, fit basedim=10pt]{name=third,column=3,row=1,span=1,rowspan=1}{
  \bklTitle{\Glsfmtlongpl{ep}}
  \input{config/rules/exhaustion.tex}
  \input{config/rules/weight.tex}
}

\posterbox[blankest, fit, fit basedim=10pt,adjusted title=Skills]{name=fourth,column=4,row=1,span=1,rowspan=1}{
  \label{skillChart}
  \setcounter{page}{4}
