...
%----
  \posterbox[
    ...
    remember,
  ]{name=attributes,column=1,row=4,span=4,rowspan=6}{
...
%----
  \posterbox[
    ...
    valign=center,
    colback=white,
  ]{name=gumption,column=3,row=19,span=3,rowspan=4}{
    \begin{tikzpicture}[
circle label/.style = {
        postaction={
            decoration={
...
%----
  ...
  remember,
  ]{name=melee,column=5,row=4,span=2.5,rowspan=6}{
    \renewcommand{\arraystretch}{1.2}
...
%-----
  ...
  {name=skills,column=1,row=10,span=2.8,rowspan=9}{
    \renewcommand{\arraystretch}{1.2}
    \begin{tabularx}{\linewidth}{Xr@{}}
      \hiderowcolors
      \skill{Academics}
