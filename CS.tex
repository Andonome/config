...
circle label/.style = {
     ...
     \path[circle label={FP = XP / 10 + Charisma}] (0,-9mm) arc (-90:360-90:9mm);
      \draw[dotted] (0,0) node [align=left,text width=3.5em,minimum size=17mm,draw,circle] {};
     ...
     \path[circle label={MP = 3 x spheres}] (0,-31mm) arc (-90:360-90:9mm);
      \draw[dotted] (0,-22mm) node [align=left,text width=3.5em,minimum size=17mm,draw,circle] {};
    \end{tikzpicture}
    \vspace{3em}
  }
%----
