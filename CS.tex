\begin{tcbposter}[
  ...
  boxes    = {
    ...
    boxed title style={
      frame code={
        \path[draw=\pageOppositeColor, tcb fill frame] ([xshift=-4mm]frame.west)
        -- (frame.north west) -- (frame.north east) -- ([xshift=4mm]frame.east)
        -- (frame.south east) -- (frame.south west) -- cycle;
      },
      interior code={ \path[draw=\pageOppositeColor, tcb fill interior] ([xshift=-2mm]interior.west)
...
%----
  \posterbox[
    ...
    \begin{tabularx}{\linewidth}{lXlXlX}
      ...
      \textbf{Debt:} & \iftoggle{examplecharacter}{\sffamily\characterDebt~\glsfmtplural{sp}}{\lightDots} &
      & &
      \\
    \end{tabularx}
}
...
%-----
  ...
  {name=derived,column=2,row=6,span=18,rowspan=4}{
    ...
    \begin{tabularx}{\linewidth}{XXXX}
      \hiderowcolors
      \textbf{\Glsentrytext{dr} / \Glsentrytext{covering}} & \textbf{\Glsentrytext{ap}} &\textbf{Attack} & \textbf{Damage} \\
      \vspace{3em}
      \\
      \\
      \\
      \iftoggle{examplecharacter}{\sffamily\arabic{armourDR}/ \arabic{covering}}{\underline{\hspace{2em}/\hspace{2em}}}
      &
      \iftoggle{examplecharacter}%
      {%
