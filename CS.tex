...
%----
  ...
  \iftoggle{examplecharacter}{\sffamily\characterEquipment\vspace{14em}}{\lineDots[3]\vspace{1em}}

  
  \glsentryshortpl{cp}
  \iftoggle{genExamples}{\arabic{gold} }{\weeline}
...
%------
  ...
  \setlength{\parskip}{0mm}
    \small Total:
    \iftoggle{examplecharacter}{\sffamily 50 }{ }
    \tcblower
    \small Unspent:
  }
