...
%----
  \posterbox[
    ...
    remember,
  ]{name=attributes,column=1,row=2,span=4,rowspan=2.9}{
...
circle label/.style = {
     ...
     \hspace{2em}
     \path[circle label={FP = XP / 10 + Charisma}] (0,0.6) arc (-90:360-90:1.1);
      \draw[dotted] (0,1.7) circle (1) node [align=left,text width=3.5em] {};
     \path[circle label={MP = 3 x spheres}] (3,0.6) arc (-90:360-90:1.1);
      \draw[dotted] (3,1.7) circle (1);
    \end{tikzpicture}
...
%----
    ...
    blankest,
      ...
      \par
      \noindent%
      \textcolor{gray}{\tiny \glsentrylong{weight}}%
    }
    %
    \setcounter{diceNo}{0}
...
%----
  ...
  \setlength{\parskip}{0mm}%
    \iftoggle{examplecharacter}{
      \sffamily
      \ifStrSame{\race}{Dwarf}{Tenacity: Half penalties from poison}{}%
      \ifStrSame{\race}{Elf}{Thermal Apathy: take no \glsentrylongpl{ep} from natural heat variations}{}%
      \ifStrSame{\race}{Gnoll}{Teeth: grab and grapple in a single manoeuvre}{}%
      \ifStrSame{\race}{Gnomes}{Attentiveness: Roll 2D6+3 for \glsfmtplural{restingaction}}{}%
      \ifStrSame{\race}{Human}{Marching Legs: each \glsentrylong{ep} spent to march gains an extra~mile}{}%
      \par
      \vspace{2\baselineskip}
      \Knacks
    }{%
