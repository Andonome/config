...
%----
    ...
    \Repeat{12}{
      ...
      \posterbox[
      blankest,
      ]{column=19,row=\arabic{track},span=10,rowspan=1}{%
        \ifcase\value{diceNo}\relax%
        \or%
          \ifdefempty{\weaponName}{\lightDots}{%
            {\sffamily\weaponName~Bonus\hfill}%
          }%
          \raisebox{4pt}{\showDots{weaponBonus}}%
        \or%
          \ifdefempty{\weaponName}{\lightDots}{%
            {\qquad\sffamily Damage\hfill}%
          }%
          \raisebox{4pt}{\showDots{weaponDamage}}%
        \or%
          \ifdefempty{\armourName}{\lightDots\showDots{armourDR}}{%
            {\sffamily \expandafter\MakeUppercase\armourName~\gls{dr}}%
            \hfill\raisebox{4pt}{\showDots[5]{armourDR}}%
          }
        \or%
          \ifdefempty{\armourName}{\lightDots\showDots{covering}}{%
            {\qquad\sffamily \gls{covering}}%
            \hfill\raisebox{4pt}{\showDots[5]{covering}}%
          }
        \or%
        ...
        \ifnum\value{hp}<\value{diceNo}%
          \raggedleft\tikz \draw[dotted] (0,0) node[minimum size=15mm,draw,circle] {\textcolor{\pageSideColor}{\Large\Roman{diceNo}}};
        \else
          \raggedleft\tikz \draw[dotted] (0,0) node[minimum size=15mm,draw,circle] {\textcolor{\pageOppositeColor}{\Large\Roman{diceNo}}};
        \fi
      }
    }
