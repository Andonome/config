...
\begin{tcbposter}[
  ...
  \posterbox[
    ...
    \label{gmSheet}
    \large
    Campaign: \lineDots Season: \lineDots
}{
    }
...
%---
  ...
  \posterbox[blankest]{name=interval,below=pcs,span=26}{
    ...
    \begin{tabular}{lccccl}
      & \showInterval{1} & \showInterval{2} & \showInterval{3} & \showInterval{4} & \small\flourish \\
      & \Square & \Square & \Square & \Square & \\
    \end{tabular}%
    }
    %\begin{tabular}{cccc}
    %  \Square & \Square & \Square & \Square \\
    %  \showInterval{1} & \showInterval{2} & \showInterval{3} & \showInterval{4} \\
    %\end{tabular}
    %\foreach \x in {1,...,4}{
    %  %\foreach \n in {1,...,4}{{\tiny \n}\Square~}
    %}
