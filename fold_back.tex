...
\draw [overlay,loosely dotted] ([xshift=-2em,yshift=2em]current page.south) -- ([xshift=-2em,yshift=-6em]current page.north) ;
...
\posterbox[tikz={rotate=180}]{name=eleventh,column=3,row=1,span=1,rowspan=1}{
  ...
  \subsubsection{\Glsfmttext{retreat}}
  \glsdesc{retreat}.
}
