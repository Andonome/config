...
\longnewglossaryentry{navigation}{
  ...
  type={mech},
  category={rules},
  description={becomes an issue when nobody can identify a landmark; a mountain, \glsfmttext{broch}, or weird tree can all serve as landmarks.
    When the major landmarks are no longer visible, characters make an \roll{Intelligence}{Survival} at \glsfmttext{tn}~10 at the start of the \glsfmttext{interval}.
    Each Failure Margin increases the travel distance by 1~Mile},
}
