...
\newglossaryentry{broch}{
  ...
  text={broch},
  prefix={a\space},
  description={ (pronounced like `loch') are the tall, round towers used by travellers, and maintained by the \glsentrytext{guard}},
}
...
\newglossaryentry{Qualmea}{
  ...
  prefix={a\space},
  nonumberlist,
  description={ -- \glsentrytext{fenestra}'s first season, when the ground quakes, and the \glsentrytext{ainumar} creates a giant eclipes},
}
