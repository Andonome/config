...
\longnewglossaryentry{navigation}{
  ...
  type={mech},
  category={rules},
  description={is seductively easy, as the difficulty changes suddenly.
    The roll uses \roll{Intelligence}{Survival} at \tn[7], but swings rapidly, depending on the conditions.
...
\longnewglossaryentry{impromptuThrownWeapons}{
  ...
  prefix={an\space},
  parent={projectile},
  description={receive a -2 penalty to hit and Damage, and a further -1~Penalty to hit per \glsentrytext{step}~thrown},
}
