...
\longnewglossaryentry{weight}{
  ...
  nonumberlist,
  parent={equipment},
  long={Characters can carry a total Weight equal to their current \glsfmtplural{hp}; every Point beyond becomes a Penalty to all actions},
  description={estimates how easily someone can carry an item, given its mass, and how bulky it feels.
  Characters can carry a total Weight Rating equal to their current \glsfmtplural{hp}.
  Each point beyond inflicts a -1~Penalty to all actions.

  Creatures have a total \glsentrytext{weight} equal to their maximum \glsentrytext{hp} plus the Weight of any items they carry},
}
...
\longnewglossaryentry{harvesting}{
  ...
  description={means preparing plants and field dressing the useful parts from \glsfmtplural{monster}, especially for \glsfmtplural{ingredient}.
    ...
    The dressed meat has a total \glsentrytext{weight} equal to double the creature's \glsfmtlongpl{hp}},
}
