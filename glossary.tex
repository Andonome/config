...
\renewcommand*{\glstopicSubPreLocSep}{~\textcolor{\pageSideColor}{\adforn{38}}~}
...
\setglossarypreamble{In this land, people move under tall trees, like ants through blades of grass.
...
\longnewglossaryentry{coin}{
  ...
  nonumberlist,
  parent={equipment},
  description={become heavy quickly, gaining a total \glsentrytext{weight} of 1 for every 100, so a small chest of 1,000 coins would have a total \glsentrytext{weight} of 10},
}
