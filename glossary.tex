...
\longnewglossaryentry{casting}{
  ...
  If a caster can think of a way to use a spell to stop a sword, they can enter combat as usual, rolling at \glsentrytext{tn} 7 plus the \glsentrytext{npc}'s \roll{Dexterity}{Melee}.
...
\longnewglossaryentry{chitincrawler}{
  name={Chitincrawlers},
  text={chitincrawler},
  prefix={a\space},
  parent={monster},
