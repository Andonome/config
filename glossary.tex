...
\longnewglossaryentry{foraging}{
  ...
  type={mech},
  category={rules},
  short={Roll \roll{Wits}{Survival} at \glsentrytext{tn}~%
...
\longnewglossaryentry{vitalShot}{
  ...
  category={rules},
  parent={armour},
  short={Attack which equal the \glsentrytext{tn} plus \glsentrytext{covering} ignore all \glsentrytext{dr}},
...
\longnewglossaryentry{weight}{
  ...
  nonumberlist,
  parent={equipment},
  short={Characters can a total Weight equal to their current \glsfmtplural{hp}; every Point beyond becomes a Penalty to all actions},
