...
\longnewglossaryentry{bow}{
  ...
  The hunting bow gives a Bonus to hit equal to its Damage, if the archer has time to draw properly (i.e. they still have positive \glsfmtplural{ap} after firing).
  Flustered archers, take the weapon's Bonus to hit as a Penalty if they would not be able to fire in time},
}
