...
\longnewglossaryentry{caving}{
  ...
  description={means co\"ordinating the \glsentrytext{deep}, where long caverns spread like veins, the logistics of travel twist and invert, and the dangers change.
    ...
    \sidebox{
      \begin{boxtable}[YYY]
        \textbf{Miles} & \textbf{\Glsfmttext{tn}} & \textbf{Dam.} \\
        \hline
                 3     &               ---        & ---             \\
                 4     &               8          & \dmg{0}         \\
                 5     &               9          & \dmg{1}         \\
    ...
    The dim light, scattered rocks, and strange environment limits travel to 3~miles per \glsfmttext{interval}.
    Marching faster presents the danger of falling off something high, or knocking your head on something.
    Sprinting through a cavern is practically insane.
    Whoever walks at the front needs to make the \roll{Wits}{Caving} roll; failure inflicts Damage and cuts the journey to a mile, while a tie just inflicts Damage (and requires the \glsfmttext{gm} to note the approaching Damage for later)},
}
...
\longnewglossaryentry{blackWalking}{
  ...
  It reduces the standard travel rate by 2 miles, so characters can walk 1 mile over the \glsfmttext{interval}, or travel 3 miles and risk Damage},
}
