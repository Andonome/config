...
\longnewglossaryentry{interval}{
  ...
  After each Interval, each \glsentrytext{pc} regenerates:
    ...
    \begin{itemize}
      ...
      \item
      The \glsentrytext{gm} rolls $1D6$ and all resting characters gains that many \glsfmtplural{fp}.
      \item
...
\longnewglossaryentry{ambush}{
  ...
  An impromptu ambush might involve just sneaking up on someone with \roll{Dexterity}{Stealth}, but visibility should inflict a steep Penalty, and the ambush won't help teammates},
}
...
\longnewglossaryentry{projectile}{
  ...
  prefix={a\space},
  parent={combat},
  description={rolls use \roll{Dexterity}{Projectiles} at \glsentrytext{tn}~7 plus 1 for every 5~\glsfmtplural{step} distance.
  On a tie, the character fumbles; the shot misses, but the characters retains the projectile and spends no more than 1~\glsentrytext{ap}.

  Targets can resist with \roll{Speed}{Vigilance} by spending \pgls{ap}},
}
...
\longnewglossaryentry{bow}{
  ...
  The hunting bow gives a Bonus to hit equal to its Damage, if the archer has time to draw properly (i.e. does not have negative \glsfmtplural{ap}).
  Flustered archers, take the weapon's Bonus to hit as a Penalty when using it in \pglsxtrlong{resistedaction}\glsfmttext{resistedaction}},
}
