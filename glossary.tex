...
\longnewglossaryentry{foraging}{
  ...
  \ifcase\thetemperature 14\or 12\else 10\fi.%
  Success means supplies for $1D6$ \glsfmtplural{ration}, but only once cooked (\roll{Intelligence}{Cultivation}, \glsentrytext{tn}~10)},
  description={can provide verdant supplies, easily, with just one \glsentrytext{interval} of foraging.
  The player rolls \roll{Wits}{Survival} at \tn[12] (+2~Bonus during \glsentrytext{cFive}, -2~Penalty over \glsentrytext{cTwo}, and a -4~Penalty at night).
