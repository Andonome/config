...
\longnewglossaryentry{crawler}{
  ...
  prefix={a\space},
  parent={monster},
  description={is an arachnid the size of a horse.
  Some say the face looks more like a wolf's, others say it looks almost human.
  Each leg ends in sharp claws},
}
...
\longnewglossaryentry{cutter}{
  ...
  sort={R3},
  parent={guard},
  description={journey past the \glsentrytext{edge}, and begin the work of starting new settlements},
}
