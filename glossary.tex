...
\newacronym[
  description={coins on the character sheet make a simple, linear, measure of a character's health and injury},
  shortplural={HP},
  prefix={a\space},
  ]{hp}{HP}{Health Point}
...
\newglossaryentry{wheatGuild}{
  ...
  They prefer to be known as `the Wheat Guild', but many refer to them as `the Temple of Poison' anyway}
}
...
\newglossaryentry{healersGuild}{
  ...
  prefix={a\space},
  sort={Temple of Sickness},
  symbol={\glsentrytext{sickness}},
  description={(also known as `the Healders Guild') tend to the dying, to ferry people into \glsentrytext{eldren}'s realm.
...
\newglossaryentry{weaversGuild}{
  ...
  This `Temple of Frost' exists to thwart \glsentrytext{sable}, by keeping people warm}
}
...
\newglossaryentry{wrecan}{
  name={Wrecan},
  description={is goddess of hatred, bigotry, and vengeance.
...
\newglossaryentry{armourHall}{
  ...
  This `Temple of Hate' protects civilization from \glsentrytext{wrecan}}
}
...
\newglossaryentry{yonder}{
  ...
  When idiots go to investigate something which sensible people would leave alone, they say their soul goes to live with \glsentrytext{yonder} in a state of eternal confusion},
}
...
\newglossaryentry{paperGuild}{
  ...
  This `Temple of Light' works against \glsentrytext{yonder}, by educating people}
}
