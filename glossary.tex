...
\newglossaryentry{village}{
  ...
  text={bailey},
  prefix={a\space},
  description={-- a walled village, which stands beyond the protection of any other civilization}
}
...
\newglossaryentry{bothy}{
  ...
  plural={bothies},
  prefix={a\space},
  description={provide enough room for travellers and their horses to rest for the night, on the road.
  The \glsentrytext{guard} often stay, as they spend much of their time wandering the roads}
}
...
\newglossaryentry{wheat}{
  ...
  text={\ifodd\thepage Wheat \else Poison \fi Guild},
  prefix={a\space},
  description={which protects humanity from poison through baking and brewing}
}
...
\newglossaryentry{hate}{
  ...
  sort=Hate,
  nonumberlist,
  name={\adfrightarrowhead\adfleftarrowhead},
