...
\newcommand\townDoula{
  ...
  \begin{minipage}{\linewidth}
    ...
    \begin{nametable}[LcX]{\pinLocation{Doula}\marketDoula's \glsentrytext{doulaShop}}
      \textbf{Things on shelves} & \textbf{Weight} & \textbf{Cost} \\\hline
      \rareMarketItem[7]{Air \Glsentrytext{boon}}{1}{24}%
      \rareMarketItem[7]{Fire \Glsentrytext{boon}}{1}{24}%
      \rareMarketItem[7]{Earth \Glsentrytext{boon}}{1}{24}%
      \rareMarketItem[7]{Water \Glsentrytext{boon}}{1}{24}%
