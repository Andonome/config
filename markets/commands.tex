...
\newcommand\butcherStall{
  \renewcommand\npcsymbol{\flourish}
  \begin{nametable}[Lcccc]{At \composeHumanName\ the Butcher's\footnote{\sffamily The butcher buys bodies at half the value of their \gls{cr} in \glspl{sp}, or a quarter if he already has some.}}
