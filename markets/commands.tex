...
\newcommand\townPitOfJustice{
  ...
  \begin{nametable}[Lc]{\pinLocation[1,-1]{Pit}\Glsentrytext{court}}
...
\newcommand\townSquare{
  ...
  \end{nametable}
  \pinLocation{Square}
  \pinLocation[5,0]{SquareRight}
}

\newcommand\innOne{
  \renewcommand\npcsymbol{\flourish}
  \begin{nametable}[Xc]{\pinLocation{InnOne}\marketInnOne}
    \textbf{Hospitality} & \textbf{Cost} \\\hline
...
\newcommand\innTwo{
  \renewcommand\npcsymbol{\pinLocation[2,0]{InnTwo}\glsentrysymbol{abderian}}
...
\newcommand\townHealers{
  ...
  \begin{minipage}{\linewidth}
    ...
    \begin{nametable}[Lcl]{\pinLocation{Healers}At the \Glsentrytext{templeOfSickness}}
...
\newcommand\townDocks{
  \stepcounter{footnote}%
  \pinLocation[5,-1]{Crossroad}
  \renewcommand\npcsymbol{\flourish}
  \begin{nametable}[Lcc]{At the Docks\footnotemark[\value{footnote}]\pinLocation{Docks}}
...
\newcommand\townCuriosity{
  ...
  \begin{nametable}[Lcc]{At the \glsentrytext{templeOfCuriosity}\pinLocation{Library}}
...
\newcommand\townArmoury{
  \begin{minipage}{\linewidth}
    \renewcommand\npcsymbol{\glsentrysymbol{wrecan}}
    \begin{nametable}[Lcccc]{At the \Glsentrytext{templeOfHate}\pinLocation[1,0]{Armoury}}
      \textbf{Armour} & \textbf{\Glsentrytext{dr}} & \textbf{\glsentrytext{covering}} & \textbf{Weight} & \textbf{Cost} \\\hline
...
\newcommand\townTanner{
  \renewcommand\npcsymbol{\glsentrysymbol{wrecan}}
  \begin{nametable}[Lcccc]{At the Tanner's\pinLocation[2,-1]{Tanners}}
    \textbf{Armour} & \textbf{\Glsentrytext{dr}} & \textbf{\glsentrytext{covering}} & \textbf{Weight} & \textbf{Cost} \\\hline
