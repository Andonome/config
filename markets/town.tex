...
\begin{nametable}[Lcl]{At the \Glsentrytext{templeOfSickness}}
  ...
  Medical supplies (+1~Bonus) & 0 & \mkPrice[cp]{30} \\

  Medical supplies (+2~Bonus) & 1 & \mkPrice{3} \\
...

{
  \footnotesize
  \noindent
  \Glsfmttext{mixer} \marketMixer\ has $1D3$ of each item and will purchase \glsentrytext{ingredient} for \glsfmtplural{sphere} which the \glsentrytext{temple} currently lacks for \mkPrice{12}.
}
