...
\begin{minipage}{\linewidth}
  ...
  \begin{nametable}[Lcc]{\composeHumanName's \glsentrytext{doulaShop}}
    ...
    \rareMarketItem{Air \Glsentrytext{ingredient}}{1}{23}%
    \rareMarketItem{Fire \Glsentrytext{ingredient}}{1}{23}%
    \rareMarketItem{Earth \Glsentrytext{ingredient}}{1}{23}%
    \rareMarketItem{Water \Glsentrytext{ingredient}}{1}{23}%
    \rareMarketItem{Fate \Glsentrytext{ingredient}}{1}{23}%
...
\begin{nametable}[Xcl]{At the \Glsentrytext{templeOfSickness}}
...
\begin{nametable}[Lc]{\Glsentrytext{court}}
  ...
  (petty crime) & \mkPrice[gp]{3} \\

  Bribery (minor crime) & \mkPrice[gp]{6} \\
