...
\begin{nametable}[Lcc]{At the \glsentrytext{templeOfCuriosity}}
  ...
  \rareMarketItem[14]{Lode stone}{0}{8}%

  \rareMarketItem[10]{Magnifying globe}{2}{4}%

  \rareMarketItem[12]{Magnifying glass}{1}{7}%

  \rareMarketItem[12]{Strange map}{0}{5}%

  \rareMarketItem[7]{Oil-lantern}{1}{15}%

  Lantern oil (3~hr.) & \ensuremath{\frac{1}{3}} & \mkPrice[cp]{30} \\
