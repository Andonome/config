...
\footnotetext[1]{This item is illegal, and requires a \roll{Charisma}{Empathy} roll (\tn[10]), to gain trust along the line of people who lead to the real seller.
...
\begin{nametable}[Lc]{Central Square}
  ...
  \ifodd\value{r4}%
    \stepcounter{r6}
    \tiny\marketFence, the Fence\footnotemark[1] & \tiny \arabic{r6}0\% and shhh\ldots \\
  \fi%
...
\footnotetext[4]{There is no sale, just 1D6 thugs who want your money.}
...
\begin{nametable}[Lcc]{At the Docks}
  ...
  Lock-pick set\ifodd\value{r2}\footnotemark[1]\else\footnotemark[4]\fi (+\arabic{r2}~Bonus) & 0 & \mkPrice{10} \\
