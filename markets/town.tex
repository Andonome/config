...
\begin{nametable}[Lcc]{\glsentrysymbol{sable}~At the \glsentrytext{templeOfFrost}}
...
\begin{minipage}{\linewidth}
  \begin{nametable}[Lcc]{\glsentrysymbol{nulla}~\composeHumanName's \glsentrytext{doulaShop}}
  ...
  The \gls{doula} will purchase \glsfmtplural{ingredient} for half the cost listed here.
  She will also prepare \glsfmtplural{ingredient} to cure people for the price of the \glsentrytext{ingredient} plus a favour owed.
\end{minipage}
\fi
...
\begin{nametable}[Lc]{Central Square}
  ...
  Performance by \composeHumanName, the Minstrel & \mkPrice[cp]{90}/ song \\
...
\begin{nametable}[Lcc]{\glsentrysymbol{yonder}~At the \glsentrytext{templeOfCuriosity}}
...
\begin{nametable}[Xcl]{\glsentrysymbol{eldren}~At the \Glsentrytext{templeOfSickness}}
...
\begin{multicols}{2}
\begin{nametable}[Xcccc]{\glsentrysymbol{wrecan}~At the \Glsentrytext{templeOfHate}}
...
\begin{nametable}[Xcccc]{\glsentrysymbol{wrecan}~At the Tanner's}
  \textbf{Armour} & \textbf{\Glsentrytext{dr}} & \textbf{\glsentrytext{covering}} & \textbf{Weight} & \textbf{Cost} \\\hline
