\spell{Snowcastle}% Name
  ...
  {The caster cries to every snowflake in a snowstorm, to settle and bind into ice.
    Brick by brick, they form a castle of ice, with an area of \arabic{spellTargets} square \glspl{step}}% Description
  {
    ...
    A maze-like castle will add +\arabic{spellPlusTwo} to the \gls{tn} to navigate it, while an impregnable castle will add a penalty to assault it.
  }
