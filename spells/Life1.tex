\spell{Brawlform}% Name
  ...
  Each added Strength point demands an extra meal every day, and inflicts a -\arabic{spellCost} Charisma penalty due to ugly distortions (along with the loss of an equal number of \glspl{fp}).
  Each point of \gls{dr} inflicts 1~Damage}% Description
  {
