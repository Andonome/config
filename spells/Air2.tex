...
\spell{Wind Blast}% Name
  ...
  {As the caster shouts `mrsh!', \arabic{spellTargets} lose \arabic{spellPlusTwo}~\glspl{ap} and get pushed back \arabic{spellPlusTwo}~\glspl{step} minus their Strength Bonus}% Description
  {}
