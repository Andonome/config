...
\spell{Sun Flare}% Name
  ...
  Nearby lights flash.
  If cast in darkness, everyone within \spellRange\ of an affected light source blinks in confusion, and takes a -\arabic{spellPlusOne}~Penalty to anything involving vision, for the rest of the round}% Description
