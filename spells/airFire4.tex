\spell{Storm Blast}% Name
  ...
  {\arabic{spellTargets} targets lose \arabic{spelllevel} \glspl{ap} while lightning hits them for \arabic{spelllevel} Damage}% Description
  {
    ...
    The resulting boom inflicts \dmg{spelllevel} Damage on \arabic{spellTargets} targets, and reduce their \glspl{ap} by \arabic{spelllevel}.
