...
\spell{Chaos}% Name
  ...
  {The \gls{spell} lasts until the character focusses on a joyful memory (marose \glspl{pc} may use \pgls{storypoint}).
  Each memory becomes sullen after the \gls{spell}'s abuse.}
