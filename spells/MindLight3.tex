\spell{Glorious Vision}% Name
  ...
  The target gains a +\arabic{spellPlusOne} Bonus to Wits for anything which helps \emph{directly} with that goal, but a -\arabic{spellPlusOne} Penalty to all Mind \glspl{attribute} when not completing the goal.
