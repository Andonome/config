\spell{Blessing}% Name
  ...
  {The mage blesses the target with high hopes for their future, bestowing \showDam{spellPlusTwo}~\glspl{fp} immediately}% Description
  {}
...
\spell{Twisted Fate}% Name
  ...
  {The caster hexes the target with death on the road, hoping they will not meet their destination.
    Within $1D6$ days, the target meets with a monstrous encounter}% Description
  {
