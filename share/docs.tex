...
\begin{boxtext}[The end?]
  And of course\ldots BOXTEXT!
  The optional argument changes the default
  ending of `what do you do?'.
\end{boxtext}
...
\subsection{\Glsfmtplural{action}}

You can write standard actions like this:

\begin{verbatim}

When writing, goblins might roll
\roll{Speed}{Academics},
because they think more letters makes more smarts.

\act{read the book}{Intelligence}{Academics}{3}

\act[Anyone who knows what's inside]%
{burn the book}{Intelligence}{Cultivation}{4}

\humandiplomat

\act{tell the diplomat about the book}%
{Charisma}{Cultivation}%
{\roll{Intelligence}{Academics}}

\act[Those who want brain-damage directly]%
{eat the book}{Speed}{Athletics}%
{\roll{Strength}{Academics}}

\end{verbatim}

When writing, goblins might roll \roll{Speed}{Academics}, because they think more letters makes more smarts.

\act{read the book}{Intelligence}{Academics}{3}

\act[Anyone who knows what's inside]{burn the book}{Intelligence}{Cultivation}{4}

\humandiplomat

\act{tell the diplomat about the book}{Charisma}{Cultivation}{\roll{Intelligence}{Academics}}

\act[Those who want brain-damage directly]{eat the book}{Speed}{Athletics}{\roll{Strength}{Academics}}
...
Since the subsection is never used in a table of contents, we can misuse it to contain rules, and then reference the rule.
Specifically, you can use

\verb"\footnote{\nameref{keepingWatch}.}"

This produces a footnote with a summary of that rule, which will automatically update if the rule ever changes.
