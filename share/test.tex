...
\thepageDarkness~\showCycle~\foliage\foliage
...
\begin{tabular}{ccccccccccc}
  \hline
  \textbf{r0t1} & \textbf{r0t3} & \textbf{rn1t0} & \textbf{rn1t2} & \textbf{rn3t3} & \textbf{r2t3} & \textbf{r2t4} & \textbf{r3t4} & \textbf{r4t5} & \textbf{r4t6} & \textbf{r12} \\\hline
...
\printThreadsInRegion{Slums}

\section*{Artgate}

\printThreadsInRegion{Artgate}

%\handout[market]{config/markets/town}
...
\humansoldier[
  \npc{\T[2]\Hu}{\thenoAppearing~Mounted Soldiers}
  \Mount{Horses}% Name
  {3}% Strength
  {0}% Dexterity
  {1}% Speed
...
\tableofcontents{3}{Test Page}{With a lot of nonsense}
