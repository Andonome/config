\newcommand\physicalSkillChart{
  \begin{nametable}[r|LLL]{Physical Attribute -- Skill Pairs}
    ...
    \textbf{Vigilance} & Keeping watch all night & Feeling for an exit in the dark & Running through a misty graveyard \\
    \hline
  \end{nametable}
}
...
\newcommand\mentalSkillChart{
  ...
  \begin{nametable}[r|LLL]{Mind Attribute -- Skill Pairs}
    ...
    \textbf{Stealth} & Steganography & Quickly hiding & Sleuthing a banquet, uninvited \\
