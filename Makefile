...
statblocks.pdf: share/statblocks.tex $(DROSS)/statblocks-switch-gls ## statblocks generated from share/Monster.rec
share/statblocks.tex: recfiles/template_head.tex recfiles/animal.tex recfiles/person.tex recfiles/Monster.rec
	cp $< $@
